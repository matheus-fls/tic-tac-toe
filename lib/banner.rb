...
class Character
    ...
    def initialize 
        @scan_lines = []    # Strings to represent the character
    end
...
class Alphabet
  ...
  # Reads the letters representation, splits it and initialize each character scan lines
  def read
...
alphabet = Alphabet.new width, height
alphabet.read

# Write an action using puts
# To debug: STDERR.puts "Debug messages..."

puts alphabet.to_banner 'OOX'
puts alphabet.to_banner 'OXO'
puts alphabet.to_banner 'XXX'
=end
